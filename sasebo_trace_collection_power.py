...
def main():
    ...
    #Set the IP Value every time you change the setup
    scope.MakeConnection("IP:169.254.67.251")
    ...
    #For sakura board the trigger is always set to auto
